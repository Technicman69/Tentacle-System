...
execute if score @s tent.node_id matches 11..16 run particle minecraft:dust 0 0 0 0.5 ^ ^ ^ 0.03 0.03 0.03 1 1 normal
execute if score @s tent.node_id matches 11..16 unless entity @s[distance=..0.2] run particle minecraft:dust 0 0 0 0.5 ^ ^ ^0.2 0.03 0.03 0.03 1 1 force
execute if score @s tent.node_id matches 11..16 positioned ^ ^ ^0.2 unless entity @s[distance=..0.2] run particle minecraft:dust 0 0 0 0.5 ^ ^ ^0.2 0.03 0.03 0.03 1 1 normal
execute if score @s tent.node_id matches 11..16 positioned ^ ^ ^0.4 unless entity @s[distance=..0.2] run particle minecraft:dust 0 0 0 0.5 ^ ^ ^0.2 0.03 0.03 0.03 1 1 force